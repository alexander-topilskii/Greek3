...
- **Блоки** — в `words/blocks/` только **ссылки** на слова (как уроки). Слово получает одну метку блока; при конфликте — наиболее ранний блок. См. `agents/MD_FORMAT.md` → «Блоки учебника»
