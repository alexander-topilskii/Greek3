...
- **Уроки** — в `words/lessons/` хранятся только **ссылки** на слова; сами MD-файлы слов — всегда в тематической категории (`verbs/`, `nouns/` и т.д.). При добавлении слова в урок **обязательно** создать или обновить файл в подходящей категории и ссылку в её `readme.md` (см. `agents/MD_FORMAT.md` → «Уроки»)
