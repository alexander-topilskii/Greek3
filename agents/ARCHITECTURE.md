...
Если в слове есть секция «Спряжение», `site/js/verb-cube.js` крутит куб времён (прошлое / настоящее / будущее) и переключает вид: разовое, длительное, завершённое. Повелительное и причастия — карточки под кубом.
